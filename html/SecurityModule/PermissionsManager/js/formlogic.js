...
(function() {
  ...
  formLogicExt = function($, WebOmi) {
    ...
    my.readGroups = function(callback) {
      var consts, server;
      consts = WebOmi.consts;
      server = my.authServer + "/permissions?readGroups=true";
    ...
    my.deleteGroup = function() {
      ...
      server = my.authServer + "/permissions?removeGroups=true&groupID=" + groupID;
    ...
    my.updateUsers = function(newUserItem, success) {
      var consts, request, server;
      consts = WebOmi.consts;
      server = my.authServer + "/permissions?writeUsers=true";
    ...
    my.updateGroups = function(newGroupItem) {
      var consts, request, server;
      consts = WebOmi.consts;
      server = my.authServer + "/permissions?writeGroups=true";
      consts.progressBar.css("width", "95%");
    ...
    my.readRules = function(groupID, callback) {
      var consts, server;
      consts = WebOmi.consts;
      server = my.authServer + "/permissions?readRules=true&groupID="+groupID;
    ...
    my.readUsers = function(callback) {
      var consts, server;
      consts = WebOmi.consts;
      server = my.authServer + "/permissions?readUsers=true";
    ...
    my.sendPerm = function(callback) {
      ...
      server = my.authServer + "/permissions?writeRules=true&groupID="+groupID;
